...
public:
    // Default constructor with initialization syntax
    Complex() : real(0.0), imag(0.0)
    {
        std::cout << "Complex()" << std::endl;
    }

    // Constructor with parameters and initialization syntax
    Complex(double r, double i) : real(r), imag(i)
    {
        std::cout << "Complex(" << r << "," << i << ")" << std::endl;
    }

    // Copy constructor with initialization syntax
    ...
    // Assignment operator with initialization syntax
